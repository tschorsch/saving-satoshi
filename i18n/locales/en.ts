const translations = {
  ...
  about: {
    ...
    subtitle: `The year is 2139. The last bitcoin is two weeks from being mined. For months, a clock has ticked down in Satoshi Square.`,
    intro: `As the world waits for this historic event, the network suddenly grinds to a halt.<br><br>On your Everything Watch, you receive a WhiskerWare brand holocat from someone using the name Satoshi Nakamoto. (It's like any other e-hologram, but this one is shaped like a cat.) You open the holocat by booping its nose.`,

    project: {
      title: `Bitcoin is serious, but learning about it doesn't have to be `,
      paragraph_one: `Saving Satoshi is a light-hearted, interactive role-playing game (RPG) about bitcoin tech. It combines fun, innovative challenges with storytelling and game mechanics to create a gentle entry point to bitcoin development.`,
      paragraph_two: `It's built with fun for curious coders and anyone that wants to learn how bitcoin <span className="italic">really</span> works. It's for those that have seen the magic of bitcoin open source software (₿OSS) and are are looking for ways to start contributing.`,
      paragraph_three: `Each chapter is filled with code-based lesson content, simulations, and programming exercises to make learning the esoteric details of bitcoin tech more enjoyable.`,
      paragraph_four: `With simple, straightforward examples, players build solid foundations before layering on the complexity. Through an immersive UX, rich visuals, and seamless interactions, learners are taken on a journey through a variety of topics including:`,
      chapter_topics: {
        list_one: `Finding and decoding the secret message in the genesis block`,
        list_two: `Hash functions and proof-of-work`,
        list_three: `The dynamics of pooled mining`,
        list_four: `The basics of elliptic curve cryptography and how to derive an address from public-private key pairs`,
        ...
        list_eight: `Using the Bitcoin Core RPC API and calculating the block subsidy`,
        list_nine: `Bitcoin Script`,
        list_ten: `How the Lightning network works`,
      },
      paragraph_five: `But it's not just about the curriculum. We believe bitcoin education can be just as creative and unique as the technology itself. That's why the game touches on many other fascinating elements of bitcoin like culture, history, and design.`,
      paragraph_six: `To us, bitcoin is a positive force in the world. This project is built by a passionate group of contributors under the highest standards, and it's 100% free and open source (FOSS). To learn more about how Saving Satoshi was made, see our <Link href="https://bitcoin.design/guide/case-studies/saving-satoshi" className="underline" target="_blank">case study</Link> in the Bitcoin Design Guide.`,
      paragraph_seven: `From playing the game, to running a workshop, to code contributions, there are many ways to join the Saving Satoshi community. We'd be delighted to have you. To get in touch, follow <Link href="https://github.com/saving-satoshi/saving-satoshi" className="underline" target="_blank">Saving Satoshi on GitHub</Link> and join the <Link href="https://discord.gg/eBGRaCSjg5" className="underline" target="_blank">#saving-satoshi channel</Link> on the Bitcoin Design Community Discord.`,
    ...
    contributing: {
      ...
      paragraph_one: `We're an open-source project, so all doors are open for you to help shape it.`,

      feedback: {
        title: `Feedback`,
        paragraph_one: `We're all ears! We love hearing what went well, what didn't go well, and where there is room for improvement. You can use <a href="https://docs.google.com/forms/d/e/1FAIpQLSf1xpNqUYJyvYL5IZDnxy78273pkqzfYW2Hf91H4Do4KHgy9g/viewform" target="_blank" rel="noreferrer">this form</a> to submit feedback.`,
      },

      contribute: {
        title: `Contribute`,
        paragraph_one: `All suggestions are welcome. We are also always looking for help reviewing and QA-ing code changes. For code improvements, you can directly open an issue or submit a pull request on <a href="https://github.com/saving-satoshi/saving-satoshi" target="_blank" rel="noreferrer">GitHub</a>.`,
        paragraph_two: `If you want to get involved with design, story, or anything else, join us in the #saving-satoshi channel in the <a href="https://discord.gg/B9WURkwF" target="_blank" rel="noreferrer">Bitcoin Design Discord</a>. Mention how you'd like to contribute and we'll help point you in the right direction.`,
      },
    },

    privacy: {
      title: `Our commitment to privacy`,
      paragraph_one: `At Saving Satoshi, we are deeply committed to ensuring the privacy and security of our users. We believe in transparency and want you to understand how and why we track app usage. To achieve this, we use a powerful tool called <Link href="https://umami.is/" className="underline" target="_blank">Umami</Link>.`,
      sub_heading_one: `What is Umami?`,
      paragraph_two: `Umami is an open-source analytics platform that helps us gather essential insights about how you use our app. It allows us to make data-driven decisions and continuously enhance our product to better meet your needs.  You can view the Umami dashboard <Link className="underline" href="https://visits.bitcoindevs.xyz/share/zFmD5WIus09mDxEf/Saving%20Satoshi" target="_blank">here</Link>.`,
      sub_heading_two: `What Data Do We Collect?`,
      paragraph_three: `Rest assured, we only collect non-personal and anonymized data, such as:`,
      list_item_one_title: `Product Improvement:`,
      list_item_one_text: `We use the data to identify areas where our app can be improved. By understanding how you use our app, we can make it more efficient, user-friendly, and secure.`,
      list_item_two_title: `Compatibility:`,
      list_item_two_text: `Understanding the devices and platforms you use allows us to optimize our app for various configurations, ensuring it works seamlessly for you.`,
      sub_heading_three: `Your Privacy Matters`,
      paragraph_four: `We want to emphasize that your privacy is of utmost importance to us. We do not collect any personally identifiable information, and the data we gather is used solely for the purpose of improving our app. Your data is never shared or sold to third parties.`,
      paragraph_five: `If you have any concerns or questions about our data collection practices or privacy policies, please don't hesitate to contact us. We are committed to providing you with a transparent and secure experience while using our app.`,
    },

    contributors: {
      title: `Enjoy!`,
      paragraph_one: `Saving Satoshi would not be possible without the many people that have come together over the last few years to build it. It takes a village!`,
      paragraph_two: `The core team is comprised of <Link href="https://adamjonas.com/" className="underline" target="_blank">Adam Jonas</Link>, <Link href="https://www.germanysbestkeptsecret.com/" className="underline" target="_blank">Christoph Ono</Link> (design lead), <Link href="https://satsie.dev/" className="underline" target="_blank">Satsie</Link>, <Link href="https://github.com/benalleng" className="underline" target="_blank">BenAllenG</Link> (engineering lead), <Link href="https://github.com/pinheadmz" className="underline" target="_blank">Matthew Zipkin</Link> (lesson content lead), <Link href="https://x.com/TuedonTuoyo" className="underline" target="_blank">Tuedon Tuoyo</Link>, <Link href="https://www.artassoiants.com/" className="underline" target="_blank">Art Assoiants</Link> (product manager), and 4 mysterious cats that <Link href="https://spiral.xyz/" className="underline" target="_blank">Spiral</Link> let us borrow to write the story.`,
      paragraph_three: `We have also had a number of contributors play key roles at various points. This includes, but is not limited to, <Link href="https://x.com/ecurrencyhodler" className="underline" target="_blank">ecurrencyhodler</Link>, <Link href="https://www.jtwoodhouse.com/" className="underline" target="_blank">JT Woodhouse</Link>, <Link href="https://x.com/_Jsms_" className="underline" target="_blank">JSMS</Link>, <Link href="https://github.com/afterburn" className="underline" target="_blank">Kevin Karsopawiro</Link>, <Link href="https://github.com/daviroo" className="underline" target="_blank">daviroo</Link>, <Link href="https://github.com/nully0x" className="underline" target="_blank">nully0x</Link>, <Link href="https://github.com/vinayaksh42" className="underline" target="_blank">Vinayak Sharma</Link>, <Link href="https://github.com/shaavan" className="underline" target="_blank">Shashwat Vangani</Link>, <Link href="https://github.com/aureleoules" className="underline" target="_blank">Aurèle Oulès</Link>, and <Link href="https://github.com/sabakhilji" className="underline" target="_blank">sabakhilji</Link>.`,
      paragraph_four: `A full list of code contributors can be found on <Link href="https://github.com/saving-satoshi/saving-satoshi/graphs/contributors" className="underline" target="_blank">GitHub</Link>.`,
    },
  ...
  chapter_one: {
    ...
    paragraph_one: `The year is 2139. The last bitcoin is two weeks from being mined. For months, a clock has ticked down in Satoshi Square. Up until this point, every block has had some kind of bitcoin reward, a subsidy. This is the only way new bitcoins come into existence but soon, it's about to change. After over one hundred years, the issuance schedule for bitcoin is coming to an end. The world awaits for the last block with a subsidy to be mined. It's a historical event. The end of an era.`,
    ...
    intro_two: {
      ...
      paragraph_one: `On your Everything Watch, you receive a WhiskerWare brand holocat from someone using the name Satoshi Nakamoto. (It's like any other e-hologram, but this one is shaped like a cat.) You open the holocat by booping its nose.`,
      paragraph_two: `—“Bitcoin is not dying, but it needs your help. Don't forget the cat.” – Satoshi Nakamoto`,
      paragraph_three: `—Satoshi? The Satoshi? From the white paper? No, it couldn't be. They've been presumed dead for over a century.`,
      paragraph_four: `Haven't they?`,
      paragraph_five: `Holocat: “You better get to work. I can help, but you have to start meow.”`,
    },
    ...
    genesis_one: {
      ...
      paragraph_one: `Bitcoin is censorship-resistant money. Anybody can send money by broadcasting a transaction to the network. After broadcast, transactions are packaged up into blocks by miners. Miners compete against other miners for the privilege of building on the chain. This is what keeps bitcoin decentralized.`,
      paragraph_two: `Satoshi Nakamoto, the pseudonymous inventor of bitcoin, also mined the first bitcoin block. He left the world a secret message in the very first bitcoin transaction that was ever made. Your first challenge is to find and decode it.`,
    },
    ...
    genesis_two: {
      ...
      paragraph_one: `Let's find the very first block in the bitcoin blockchain. Click the button below to open a <Tooltip id="genesis_two_paragraph_one" content="chapter_one.genesis_two.tooltip_block_explorer" theme="bg-[#30435b]">block explorer</Tooltip>  exactly at block 0, which is called the genesis block.`,
      ...
      tooltip_block_explorer: `A <a  href="https://bitcoinops.org/en/topics/block-explorers/" target="_blank" rel="noreferrer">block explorer</a> is a useful tool to quickly look up information about bitcoin transactions.`,
      tooltip_hex: `Short for hexadecimal, a numeral system that represents numbers using a base of 16.`,
    ...
    genesis_four: {
      ...
      paragraph_one: `You found the secret message Satoshi Nakamoto embedded in the genesis block. It's time to expand on what you just learned. Decode a vital clue about the story in the next challenge.`,
    },
    ...
    transacting_one: {
      ...
      paragraph_one: `Two main components of a transaction are inputs and outputs. In the previous exercise we decoded a secret message found inside a transaction input. This time we'll decode a message that belongs to the output part.`,
    ...
    transacting_two: {
      ...
      paragraph_two: `1. Click <Link href="https://blockstream.info/tx/ff9148605a772a51cba39004df5fb042d40515967a3e38ff5294cfd017c452a9" target="_blank" className="underline">here</Link> to look at a specific transaction.`,
      paragraph_three: `2. Open up the details and find the part that is of type “OP_RETURN”.`,
      paragraph_four: `3. Now locate the “SCRIPTPUBKEY (ASM)” field. See the “OP_RETURN OP_PUSHBYTES_33" part? These are called opcodes. We're actually interested in what comes after them.`,
      paragraph_five: `4. Copy the long string of numbers after “OP_RETURN OP_PUSHBYTES_33” and paste it in the code block. `,
    ...
    transacting_three: {
      ...
      paragraph_two: `All that's left now is to decode it, just like we did in the previous exercise. You can look up the transaction again <Link href="https://blockstream.info/tx/ff9148605a772a51cba39004df5fb042d40515967a3e38ff5294cfd017c452a9?expand" className="underline">here</Link>.`,
      ...
      terminal_challenge_error: `Almost! Remember that the variable $scriptPubKeyBytes is not set for you this time.`,
    },

    outro_one: {
      title: `Outro`,
      nav_title: `Adventure calls`,
      paragraph_one: `You run down to your garage, step into your dad's old Budgetcopter, punch in the coordinates, and make your way to District 21.`,
      paragraph_two: `Despite cat allergies so intense that they apply even to holograms, the holocat comes along. You object, but cats will be cats.`,
    ...
    outro_two: {
      ...
      description: `Amazing. You completed the first chapter and learned a lot about hashes and transactions. How did it go?`,
    },
  ...
  chapter_two: {
    ...
    paragraph_one: `The coordinates Satoshi gave you don't disappoint, unfortunately: it's a warehouse, and a scary, deserted one to boot.`,
    paragraph_two: `You circle the warehouse in your Budgetcopter no less than three times. Yeah, sigh, you're probably gonna have to go in there. Your Budgetcopter's Budget Heat Detector detects nothing but darkness. If someone knows that this place exists, it's been a long time since they visited it in anything but their memory.`,

    intro_one: {
      title: `Intro`,
      nav_title: `The warehouse`,
      paragraph_one: `—HOLOCAT: “Boy, what a dump. This place had better have some e-anchovies stored somewhere. I'd even settle for some CyberKibble.."`,
      paragraph_two: `You land, steady yourself, and search for a point of ingress. There, that broken window should do the trick. You take out what's left of the window with a brick, and hop inside. The building is filled with thousands of dusty, well-preserved bitcoin miners.`,
      paragraph_three: {
      ...
      paragraph_four: `This explains all the machines in the Vanderpoole family collection.`,
      tooltip_one: {
    ...
    intro_two: {
      ...
      paragraph_one: `In the corner, a dim, barely working computer monitor with a note stuck to it sits blinking. The note says “Turn them on, stupid."`,
      ...
      paragraph_three: `Holocat jumps onto the keyboard and walks across it, showing you what keys to hit.`,
    },

    hashing_one: {
      title: `Zeroes`,
      nav_title: `The computer hums to life`,
      paragraph_one: `Either by chance, or because Holocat actually knew what she was doing, the random letters and numbers she stepped on turn into... more random letters and numbers?`,
      ...
      paragraph_three: `Of course whatever gibberish Holocat typed was wrong. She's just a sassy holographic cat!`,
    ...
    hashing_three: {
      ...
      list_one: `Just like fingerprints, hashes are unique. Barring some exceptional circumstances, the hashes for two different things should never be the same.`,
      list_two: `Hash functions are one way streets. You can't reverse engineer a hash to figure out the data used to make it.`,
      list_three: `Hashes are extremely reliable in the sense that they are deterministic. This means you can hash the same piece of data over and over again and you'll always get the same result.`,
      paragraph_one: {
        a: `The function used here is called `,
        b: `a very popular choice.`,
      },
      paragraph_two: `Now, let's see if you can find a specific hash.`,
      paragraph_three: `Find a hash that starts with a zero (“0”). Keep typing different things below until you find a hash that we want.`,
      tooltip_one: {
    ...
    hashing_four: {
      ...
      heading: `Enter anything until you find a hash that starts with a zero (“0”)`,
      hint_prompt: `Need a <Tooltip id="hint_prompt" position="bottom" theme="bg-[#5e212a]" offset="-1" content="chapter_two.hashing_four.hint_tooltip">hint</Tooltip>?`,
      hint_tooltip: `<span className="text-m whitespace-nowrap leading-none text-white/50">Try typing:</span> <span className="whitespace-nowrap text-white">popcorn</span>`,
    },
    ...
    hashing_five: {
      ...
      paragraph_one: `Let's make it a bit more tricky. Try to find a hash that starts with two zeroes ("00").`,
    },

    hashing_six: {
      title: `Zeroes`,
      nav_title: `Find a hash with two zeroes`,
      heading: `Enter anything until you find a hash that starts with two zeroes (“00”)`,
      hint_prompt: `Need a <Tooltip id="hint_prompt" position="bottom" theme="bg-[#5e212a]" offset="-1" content="chapter_two.hashing_six.hint_tooltip">hint</Tooltip>?`,
      hint_tooltip: `<span className="text-m whitespace-nowrap leading-none text-white/50">Try typing:</span> <span className="whitespace-nowrap text-white">trigonometry</span>`,
    },
    ...
    scripting_one: {
      ...
      paragraph_one: `OK, that probably took you a lot longer. Now imagine finding a hash that starts with five or ten zeroes. This is the challenge that the bitcoin network poses to miners when they want to submit new blocks with transactions.`,
      paragraph_two: `Miners gather all the information they want to put in a block such as the previous block header hash, a hash of transactions to be included in block (including the coinbase transaction), time, and combine it with a random number called a nonce (number only used once). They send all of this into the hash function to create something called the block hash.`,
      paragraph_three: `When bitcoin first launched, miners would cycle through the nonce in the block header by incrementing the data in the 32-bit field by 1. However, as miners become more powerful and efficient, the difficulty rises. Soon, it became so high that it was common to exhaust all possibilities for the 32-bit field without finding a single solution below the`,
      paragraph_four: `To address this, miners started to change other parts of the block header, such as the time or transactions included in the block.`,
      paragraph_five: `The bitcoin network has a difficulty setting and only accepts block hashes that start with a certain number of zeroes. We call this the “difficulty” and it is adjusted every 2016 blocks.`,
      paragraph_six: `For the next challenge, write a script that finds a hash that starts with five zeroes (00000).`,
      tooltip_one: {
    ...
    scripting_two: {
      ...
      paragraph_one: `Alright, time to write and run your own code. Write a script that generates a sha256 hash that begins with five zeroes ("00000..."). Your code should repeatedly call the sha256 function with different input until the output satisfies this requirement. You should try incrementing an integer inside a loop to get different inputs. In cryptography this number may referred to as a "nonce" or "number used once".`,
      python: {
        paragraph_two: `When you find a nonce with a hash that begins with five zeroes, return the nonce from the function. We are using the hashlib library in python to help you along in creating this function, you can use the following external resources to help you write this function if needed:`,
      ...
      javascript: {
        paragraph_two: `When you find a nonce with a hash that begins with five zeroes, return the nonce from the function. We are using the crypto library in JavaScript to help you along in creating this function, you can use the following external resources to help you write this function if needed:`,
    ...
    mining_one: {
      ...
      paragraph_one: `Right now, the bitcoin network requires blocks to have a hash with ten leading zeros. Let's get to it!`,
      paragraph_two: `For this simple simulation, we'll just assume that every block contains 3,500 transactions and 0.061 BTC in rewards and fees.`,
      paragraph_two_one: `See if you can turn on the miners.`,
      paragraph_three: `The code you wrote in the previous lesson to compute hashes over and over again is running.`,
      paragraph_four: `It will stop once it's found a hash with ten leading zeroes.`,
      paragraph_five: `See the nonce field incrementing? That's how many hashes you have tried so far!`,
      paragraph_six: `With the following nonce:`,
      paragraph_seven: `The resulting hash is:`,
      paragraph_eight: `It has the ten leading zeros that all new blocks require. Let's mine a few more blocks.`,
      paragraph_eight_one: `Turn the miners back on.`,
      paragraph_nine: `This might take some time. But this shows you how hard it is to mine blocks and confirm transactions.`,
      paragraph_ten: `Wow! That took quite a bit of computing power to do all that hashing. Just look how many nonces were tried!  It really helped to have that boost in hash power i.e. the number of hashes your computer can try in a second.`,
      paragraph_eleven: `As expected, since each block contains 3,500 transactions, a total of 350,000 transactions have been confirmed by the 100 blocks that were mined.`,
      paragraph_twelve: `And it looks like you've collected a nice reward for all this mining! In addition to the block subsidy, the amount of bitcoin the network rewards for each block, you've also been able to collect additional income in the form of transaction fees. `,
      paragraph_thirteen: `Remember, this was just a simulation, each block is supposed to take 10 minutes on average.`,
      paragraph_fourteen: `Also, if we were really mining on the current mainnet it would take many orders of magnitude more computing power to mine these blocks.`,
  ...
  chapter_three: {
    title: `The 51% Attack`,
    paragraph_one: `You enter the address of a block explorer and see that blocks are back to ten minute intervals. Somehow, Holocat sleeps through the noise from all the ASICs.`,
    paragraph_two: `Cats. What can you do?`,
    paragraph_three: `However, something is off. The blocks are empty, and transactions aren't processing. Did you make a mistake? Could this be a coincidence? Another message pops up on the computer screen, waking Holocat.`,
    paragraph_four: `It's not a coincidence.`,

    intro_one: {
      title: `Intro`,
      nav_title: `Hashing it out`,
      paragraph_one: `—SATOSHI NAKAMOTO: “Hey, you! Yeah, you! Remember me? Bitcoin is being hit with a 51% attack right now! After you brought those mining devices online, Vanderpoole turned BitRey's ASICs back on and is mining empty blocks. The problem is it's not just his machines. He used a backdoor on the standard ASIC firmware to infect existing miners with a virus that prevents them from mining anything but empty blocks. He's trying to hold the bitcoin ecosystem hostage and force people to support the idea of increasing bitcoin's supply. Do something, dingdong!”`,
      paragraph_two: `The old computer coughs up a cloud of dust, then produces a wad of data called a “spreadsheet” that contains contact info for some of the largest bitcoin miners, as well as a patch for the virus. The sooner you can get the patch to other miners, the sooner they can regain control of their machines and join your fight against BitRey.`,
      paragraph_three: `—HOLOCAT: “We've got more work to do. Well, you do. I'm gonna run through walls and scare mice.”`,
    },
    ...
    solo_one: {
      ...
      step_zero_paragraph_one: `While you're waiting for the miners you reached out to, you decide to see if BitRey can be fended off alone. Maybe you can put an end to the empty blocks without any help. Here's how your hash rate stacks up. How do you think this will go?`,
      step_one_heading: `We're off to the races`,
      step_one_paragraph_one: `We're now mining 100 blocks to see how many you stack up against BitRey.`,
      step_two_heading: `That didn't go well!`,
      step_two_paragraph_one: `Yikes, we just don't have enough hashpower to compete with BitRey and the virus-controlled miners. Let's see if we can defeat BitRey for the next 100 blocks with the other miners. Bitcoin has been running for over a century and it's not going down without a fight.`,
    },
    ...
    pool_one: {
      ...
      waiting_screen_paragraph_two: `Let's wait until the others join your cause so we can combine forces.`,
    ...
    pool_two: {
      ...
      step_zero_paragraph_one: `By pooling your hashrate with the other miners, can you stand up to BitRey?`,
      step_two_heading: `Another defeat!`,
      step_two_paragraph_one: `Something is wrong. Only Hashrate Hoppers found blocks. Why do you think that might be?`,
    },
    ...
    coop_one: {
      ...
      paragraph_one: `Hashrate Hoppers, the one with the most hash power, is finding all your blocks but others find nothing.`,
      paragraph_two: `The problem is that everyone is checking the same nonces while they're mining. How can you better coordinate?`,
      paragraph_three: ` You decide to place a unique identifier in the “extraNonce” when preparing the block data for each of you to prevent duplicate efforts.`,
    },
    ...
    coop_two: {
      ...
      paragraph_one: `For the Stratum mining pool protocol (not bitcoin protocol), the coinbase transaction also has something called the “extra nonce”. When providing miners with the block data, mining pools divide the extra nonce into two parts: “extranonce1” and “extranonce2”.`,
      paragraph_two: `Splitting the extra nonce into two parts has several advantages:`,
      list_one: `It prevents pool participants from doing the same work.`,
      list_two: `It allows the pool to send the same transaction list to all miners that are pooling together. That means miners simply have to update “extranonce2” and not change transactions included in the block.`,
      list_three: `The “extranonce1” allows pools to identify and determine share contribution because each miner gets their own “extranonce1”.`,
      paragraph_three: ` Miners who contribute to a pool update the “extranonce2” and cycle through the nonce in the block header. If they don't find a solution, they repeat the process with a different “extranonce2” until they do.`,
    ...
    coop_three: {
      ...
      step_zero_paragraph_one: `Let's see if we stand a chance against BitRey now with our improved strategy of dividing the nonce space.`,
      step_two_heading: `You did it!`,
      step_two_paragraph_one: `Together you and the other miners held back BitRey's attempt to overtake the network.`,
    },
    ...
    split_one: {
      ...
      heading: `Nicely done.`,
      paragraph_one: `Not only did you defend the network against BitRey, you also earned bitcoin as a reward!`,
      paragraph_two: `For every block that is mined, the miner gets a reward in bitcoin. If more than one person worked on the block, the group of miners (mining pool) gets a reward to share.`,
      ...
      paragraph_four: `You and your miner friends have earned a total of 7.41 bitcoin and are looking for a good way to split it up. It should be divided based on how much work each of you put in.`,
      paragraph_five: `Mining pools solve this by tracking how many partial solutions each miner has generated. A pool assigns each miner a minimum difficulty (lower than the block difficulty) based on their hash power. Every few seconds a miner finds one of those easier solutions and notifies the pool. The pool then tracks all the submitted shares and splits up the block rewards accordingly.`,
    ...
    split_two: {
      ...
      step_zero_paragraph: `We will re-run the battle. This time we will only focus on our pool, specifically on the number of partial solutions each miner found.`,
      step_two_heading: `Let's do the math`,
      step_two_paragraph: `Take a look at the numbers above and see if you can find a fair way to split up the rewards. Figured it out? Let's go over it step by step.`,
      step_three_heading: `Hash rate percentage`,
      step_three_paragraph: `As you know, this represents the amount of work every miner has chipped in to find blocks. But the mining pool has no way of knowing or measuring this number, since miners only forward successful solutions.`,
      step_four_heading: `Block found percentage`,
      step_four_paragraph: `The chance of finding a block is very low since it has a lot to do with luck. Especially in scenarios with some extremely powerful miners, the really small miners may contribute work but never find any blocks. `,
      step_five_heading: `Partial solution percentage`,
      step_five_paragraph: `Now this number will work. Miners report these solutions to easier problems regularly to pools. That allows pools to measure fairly accurately how much work each miner has provided.`,
      step_six_heading: `Splitting the rewards`,
      step_six_paragraph: `Now we can take the rewards of 7.41 bitcoin and split them up according to the percentage of partial solutions of each pool. Congratulations!`,
    },
  ...
  chapter_four: {
    ...
    paragraph_one: `Phew, that was close! You are shaking from your battle with BitRey, but you are relieved that you won.`,
    paragraph_two: `As you settle at your desk, you take a deep breath, drift off, and replay the day's events in your head. `,

    intro_one: {
      title: `Intro`,
      nav_title: `Securing the bag`,
      paragraph_one: `—HOLOCAT: “One of us better sleep. You need to start contacting the rest of the miners. They'll want to know even more than the world will.”`,
      paragraph_two: `As you settle at your ButtLift Hover Desk, you replay the day's events. Vanderpoole. BitRey. The revelation that miners never agreed to shut down in protest. Could it all be true? Was this all staged? And how much longer are you supposed to look after this cat? (In the distance, something meows.)`,
      paragraph_three: `Whatever happens next, you will need funds. Wait a second! You never claimed the mining rewards from your competition with BitRey! You decide to withdraw them.`,
    },
    ...
    public_key_one: {
      ...
      paragraph_one: `According to the mining pool, it looks like you have 1.61 bitcoin to claim from all the work you did earlier. `,
      list_one: ` Private key`,
      list_two: `Public key`,
      paragraph_two: `But wait, you don't even have a wallet! You might be wondering where you can buy one. While you can purchase hardware to build certain kinds of wallets, you can actually just make one with your computer or mobile device. Let's do it!`,
      paragraph_three: `If you signed up for an account at any point, you got something called a personal code. In cryptography, this is called a “private key” and it is often part of a pair:`,
      paragraph_four: ` A single key pair is all that's needed to create a wallet and control the funds within it. When you want to spend bitcoin, you use the private key. When you want to receive bitcoin, you use the public key.`,
    },

    public_key_two: {
      title: `Public key`,
      nav_title: `Elliptic curve cryptography`,
      paragraph_one: `So, we have the private key, it's the personal code you got when you signed up. How do we generate a public key from it?`,
      paragraph_two: `To do that, we need to take a peek at a fascinating branch of cryptography called elliptic curves. This is called Elliptic Curve Cryptography, or ECC for short.`,
      paragraph_three: `ECC involves taking certain points on an elliptic curve and performing addition and multiplication on the points.`,
      paragraph_four: `Bitcoin uses a specific curve called secp256k1. In the image, you see a simplified version that is easier to visualize, but follows the same mathematical rules.`,
      paragraph_five: `We start with a specific point on this curve, called the`,
      tooltip_one: {
    ...
    public_key_three: {
      ...
      javascript: {
        paragraph_three: `Complete the function <span className="text-green">privateKeyToPublicKey()</span>  which accepts a private key as a hex-encoded string and returns the corresponding public key as a GE (Group Element) object.`,
      },
      paragraph_four: `Here are some type-conversion hints to get you started:`,
      success: `Good job! That public key is pretty long. Let's try to compress it!`,
    },

    public_key_four: {
      title: `Public key`,
      nav_title: `Compress the public key`,
      paragraph_one: `The public key has an x and y coordinate for a total of 64 bytes. This can be compressed into 33 bytes by removing the y coordinate and prepending a single byte of metadata. That byte will indicate if the Y coordinate is even or odd. Because the elliptic curve equation only has two variables, the complete public key can be computed later by the verifier using only x and the metadata:`,
      paragraph_two_javascript: `The metadata byte should be '2' if y is even and '3' if y is odd. Complete the function <span className="text-green">compressPublicKey()</span> to accept a public key and return a 33 byte hex string representing the compressed public key.`,
      paragraph_two_python: `The metadata byte should be '2' if y is even and '3' if y is odd. Complete the function <span className="text-green">compress_publickey()</span> to accept a public key and return a 33 byte hex string representing the compressed public key.`,
      success: `Excellent. Now we have our compressed public key. Next we need to hash it and encode it in a human-friendly format.`,
    },
    ...
    address_one: {
      ...
      heading: `Nice work!`,
      paragraph_one: `And there you have it! Your compressed public key! There are lots of interesting things we can do with it, including generating addresses for our wallet. We'll learn about that in the next challenge.`,
      paragraph_two: `Note that generating a public key is a one way street. You can't figure out the private key used to generate a public key unless you solve a notoriously difficult math problem called the `,
      tooltip_one: {
    ...
    address_two: {
      ...
      paragraph_one: `Do you remember the hashing challenge? It turns out you can generate the simplest type of bitcoin address by hashing your compressed public key. Bitcoin uses two different hashing algorithms for this: SHA-256 and RIPEMD-160.`,
      paragraph_two: `Steps:`,
      paragraph_three: `<span className="indent-48">1. Perform a SHA-256 hash on your compressed public key.</span>`,
      paragraph_four: `<span className="indent-48">2. Perform a RIPEMD-160 hash on that SHA-256 output digest. The final result will be 20 bytes encoded as a hex string.</span>`,
      paragraph_five: `Complete a function that accepts a 33-byte compressed public key as a hex string and returns a 20-byte public key hash as a hex string.`,
      paragraph_six:
    ...
    outro_one: {
      ...
      paragraph_two: `You withdraw the bitcoin from the mining pool into the wallet you just created. You are now fully funded and ready for whatever Vanderpoole and BitRey throw at you next.`,
    },
    resources: {
      public_key_three: {
        generator_point_heading: `Generator point`,
        generator_point_paragraph: `A specific point on the secp256k1 curve. Its value is part of the secp256k1 standard and it's always the same. This point is not different from other points on the curve, but it is agreed up on as the standard starting point for calculations. No one really knows why this particular point was chosen.`,
        elliptic_curve_operations_heading: `Elliptic curve operations`,
        elliptic_curve_operations_paragraph: `Elliptic curves have their own mathematical rules, so simple operations like addition and multiplication work differently. For simplicity and brevity, established symbols are re-used, like using a “*” for operations that are similar to multiplication.`,
        discrete_log_heading: `Discrete logarithm`,
        discrete_log_paragraph: `A mathematical system where you can, for example, multiply but cannot divide. A simple metaphor for this is looking at a clock. Three hours past 11 o'clock is 2 o'clock. So we could say “11+3=2”. However if wanted to perform “2-x=11” and solve for x, you would have infinite possible answers (3, 15, 27, 39...). More on <Link href="https://en.wikipedia.org/wiki/Discrete_logarithm" className="underline">wikipedia</Link>.`,
        tip_one: `Multiplication with elliptic curve points is not the same as the kind of multiplication you are used to, the one with regular numbers. So how do you perform multiplication? Notice that the generator point, <span className="p-1 font-mono bg-[#0000004D] m-1">G</span> is of the type <span className="p-1 font-mono bg-[#0000004D] m-1">secp256k1.GE</span>. Have a look at that class to see what methods you can invoke on it.`,
        tip_two: `While the private key is accepted in hex format, it needs to be converted to a number (BigInt if you're using JS) before multiplying with the generator point.`,
      },
      public_key_four: {
        y_coordinate_compression_heading: `Public Key Compression`,
        y_coordinate_compression_paragraph: `When you calculate a point addition on an elliptic curve, you use the coordinates of two points to find the coordinates of a third point that lies on the curve. However, there are usually two possible y-coordinates for any given x-coordinate (except for certain special cases). When compressing a public key, you choose one of these y-coordinates and include only the x-coordinate along with an indicator of which y-coordinate to use, in this case we use the appended metadata to indicate the y-coordinate.`,
      ...
      address_two: {
        ...
        hash_algo_paragraph: `Hash functions digest any amount of any kind of data and always return a result of the same size. For SHA256, it's 32 bytes. For RIPEMD-160, it's 20 bytes. The output is deterministic (always the same output for the same input) but otherwise, indistinguishable from random. Hash functions effectively reduce data to a small consistent fingerprint.`,
        tip_one: `When calculating the SHA-256 hash you will need to make sure to hash your compressed key as bytes not hex. If you are using JavaScript, this will require converting the hex string to a buffer.`,
        tip_two: `Make sure you are doing the hashing algorithms in the correct order!`,
      },
      address_three: {
  ...
  chapter_five: {
    ...
    paragraph_one: `It's late, and you're tired, but as you shut your eyes for a moment, a double dose of bad news arrives.`,
    paragraph_two: `1) Vanderpoole is back on TV.`,
    paragraph_three: `2) He is claiming to be the great-grandson of Satoshi Nakamoto.`,
    paragraph_four: `He looks sleep-deprived.`,
    intro_one: {
      title: `Intro`,
      nav_title: `Don't trust, verify`,
      paragraph_one: `—DEBORAH CHUNK: “Mr. Vanderpoole. You recently made a staggering claim on anti-social media that you are the great-grandson of Satoshi Nakamoto. Is that correct? Is this true?”`,
      paragraph_two: `—VANDERPOOLE: “It darn tootin' is, Deborah. I have harbored this secret for a long, long time. You see, my family has passed an inconspicuous looking CD-ROM down for generations. To keep it secret, we labeled it <span className="italic">Creed – My Own Prison</span>. It contains the private keys to my great-grandfather Satoshi Nakamoto's enormous bitcoin trove. So when I speak for miners, know that I also speak for Satoshi Nakamoto.”`,
      paragraph_three: `—DEBORAH CHUNK: “Is there any way we can verify that you actually own the private keys to Satoshi Nakamoto's bitcoin?”`,
      paragraph_four: `—VANDERPOOLE: “Indeed there is. It is a simple matter of public key cryptography.”`,
      paragraph_five: `—DEBORAH CHUNK: But why wait so long to make this earth-shattering disclosure?`,
    },
    intro_two: {
      nav_title: `Vanderpoole's bold claim`,
      paragraph_one: `—VANDERPOOLE: “I didn't have the courage. There have always been rumors about my family's history, ones that I could have easily confirmed. But I wasn't ready for that much publicity. After all, I live a humble, secluded life in a 14th century castle on a dude ranch on my favorite of all my private islands, doing 5–6 interviews like this one from my hot tub every week.”`,
      paragraph_two: `—VANDERPOOLE: “But now that bitcoin's future is on the line, I knew it was time to face the music, specifically, the music from Creed's debut album, My Own Prison.” *Vanderpoole hums the melody from the 20th century album's namesake song*`,
      paragraph_three: `—VANDERPOOLE: "I can only say that I'm sorry for not coming forth sooner because the CD-ROM also contains Satoshi's Nakamoto's revised plans for bitcoin. You see, my great-grandfather always regretted limiting the supply of bitcoin to 21 million coins, which is why I plan to fulfill my great-grandfather's dream of hard forking bitcoin in favor of perpetual bitcoin issuance."`,
    },
    intro_three: {
      nav_title: `A message from Satoshi`,
      paragraph_one: `Your TXM4H-A Hover Screen chirps to life. You have a new message.`,
    ...
    derive_message_two: {
      ...
      paragraph_one: `We learned in chapter 4 that private keys are huge random numbers kept secret by whomever generated them. We can use Elliptic Curve math to derive a public key from that private key.`,
      paragraph_two: `The public key can be shared as a unique identifier and the private key is used to prove a person has control of that identifier. That proof is called a SIGNATURE. To create a signature you need a message and a private key. Anyone can verify the signature with a copy of the message and the corresponding public key.`,
      paragraph_three: `Vanderpoole has provided a signature and a message. Where is the public key?`,
    },
    derive_message_three: {
      ...
      success: `Nicely done! This is actually Satoshi's signature, authorizing the transfer of his bitcoin to Hal Finney.`,
    },
    derive_message_four: {
      nav_title: `Find Satoshi's public key`,
      heading: `So where is his public key?`,
      paragraph_one: `It's actually stored along with the bitcoin Satoshi generated by mining block #9.`,
      ...
      paragraph_three: `The public key lives between the script commands OP_PUSHBYTES and OP_CHECKSIG. Paste it below:`,
      placeholder: `Paste the data here`,
      success: `That's it!`,
    },
    derive_message_five: {
      ...
      paragraph_two: `Next we need to learn how to verify a signature. But something is still missing... what is the message Satoshi signed to authorize the transaction for Hal?`,
    },
    derive_message_six: {
      nav_title: `Derive the message`,
      heading: `Derive the message from the transaction`,
      paragraph_one: `It should be clear by just looking at the block explorer web page that a bitcoin transaction has many different parts. Some parts are just small numbers and some parts are larger chunks of data. The bitcoin protocol has a very specific algorithm for creating messages from transactions, so those messages can be signed by private keys.`,
      paragraph_two: `We will summarize the process outlined <Link href="https://en.bitcoin.it/wiki/OP_CHECKSIG" target="_blank" className="underline">here</Link>. It conveniently uses <Link href="https://en.bitcoin.it/wiki/OP_CHECKSIG#Code_samples_and_raw_dumps" target="_blank" className="underline">this exact same transaction from block #170</Link> as an example.`,
      paragraph_three: `To begin, we need the raw bytes that make up the complete transaction. <Link href="https://blockstream.info/api/tx/f4184fc596403b9d638783cf57adfe4c75c605f6356fbc91338530e9831e9e16/hex" target="_blank" className="underline">Our block explorer</Link> can help with this. Use the "hex" API endpoint and paste the entire blob of data.`,
      input_challenge_label: `Paste the transaction blob`,
      success_message_line_one: `This is the raw transaction with each component labeled:`,
      ...
      success_message_line_five: `index of input #0 in the funding transaction:`,
      ...
      success_message_line_nine: `output #0 value (10 BTC or 1,000,000,000 satoshis):`,
      success_message_line_ten: `output #0 scriptPubKey (Hal Finney's public key plus OP_CHECKSIG):`,
      success_message_line_eleven: `outut #1 value (40 BTC or 4,000,000,000 satoshis):`,
      success_message_line_twelve: `output #1 scriptPubKey (Satoshi's own public key again, for change):`,
      success_message_line_thirteen: `locktime:`,
    },
    derive_message_seven: {
      nav_title: `Build the message to sign`,
      paragraph_one: `It's impossible to sign a message containing it's own signature, so the scriptSig needs to be removed. In the bitcoin protocol it is actually replaced by the scriptPubKey of the transaction output we are spending.`,
      paragraph_two: `We already found the scriptPubKey in the previous step, you can paste that in the first blank.`,
      paragraph_three: {
    ...
    verify_signature_one: {
      ...
      paragraph_one: `We also have a signature we know Satoshi created with his own private keys, and we have his public key. Let's learn how to verify the signature and then we can try to verify Vanderpoole's signature.`,
    },
    verify_signature_two: {
      title: `Verify the signature`,
      nav_title: `Hash the message`,
      heading: `Hash the transaction digest`,
      paragraph_one: `The serialized transaction data we compiled in the last step is actually too long to sign or verify with ECDSA.`,
      paragraph_two: `Do we know any way to compress large chunks of data into more consistent, manageable pieces? We sure do: hashing.`,
      paragraph_three: {
        a: `The bitcoin protocol uses a `,
        b: ` to compress a transaction into a signable message.`,
      },
      paragraph_four: `Once we have a 32-byte hash, that data is re-interpreted as an integer. Yes, a 32-byte integer (that is a truly enormous number)!`,
      tooltip_one: {
    ...
    verify_signature_three: {
      ...
      paragraph_one: `Satoshi's signature is encoded in a system called DER which is a subset of ASN.1.`,
      paragraph_two: `There are two 32-byte numbers we need to extract. They are referred to as R and S respectively and are each prefixed by the bytes 0220 in the DER sequence. Instead of fully decoding the DER blob, just look for the prefixes and paste the R and S values.`,
      paragraph_three: `# Satoshi's signature, from the input scriptSig of the tx to Hal Finney (block 170)`,
    },
    ...
    verify_signature_five: {
      ...
      paragraph_one: `At this point we have everything we need to do some ECDSA math.`,
      paragraph_two: `The ECDSA signature verification algorithm is explained <Link className="underline" href="https://en.wikipedia.org/wiki/Elliptic_Curve_Digital_Signature_Algorithm#Signature_verification_algorithm" target="_blank">here</Link> and <Link className="underline" href="https://www.secg.org/sec1-v2.pdf#page=52" target="_blank">here</Link>.`,
      paragraph_three: `We created a Group Element object from the public key X and Y elements for you. You need to finish implementing the ECDSA signature verification function <span className="text-green p-1 font-mono bg-[#0000004D] m-0.5 text-sm">verify()</span> that should only return True if everything is valid!`,
      paragraph_four: `We know Satoshi's signature is valid, it has been checked by every bitcoin full node since 2010! If your program does not return True something is wrong.`,
      python: {
        paragraph_five_part_one: `Hint: the <span className="text-green">pow()</span>`,
        paragraph_five_part_two: `method can accept negative exponents and a modulus as arguments. More on the <Link className="underline" href="https://docs.python.org/3/library/functions.html#pow" target="_blank">documentation</Link>.`,
      },
      javascript: {
        paragraph_five_part_one: `We have provided a helper function <span className="text-green p-1 font-mono bg-[#0000004D] m-0.5 text-sm">invert()</span>`,
        paragraph_five_part_two: `which you will need in lieu of a JavaScript native modular exponentiation function.`,
      },
    },
    validate_signature_one: {
      ...
      paragraph_two: `First, we need to encode his message into an array of bytes corresponding to the following template:`,
      paragraph_three: {
    ...
    validate_signature_two: {
      ...
      javascript: {
        paragraph_two: {
          ...
          return: `It should return an array with the [r, s] values as BigInts.`,
        },
      },
      python: {
        paragraph_two: {
    ...
    validate_signature_three: {
      ...
      paragraph_two: `Then we can run the program to see if Vanderpoole was lying. Drumroll please...`,
      success: `This message indicates that the signature did not originate from Satoshi's public key, as the verification failed.`,
    },
    validate_signature_four: {
      title: `Validate the signature`,
      nav_title: `Find the correct key`,
      heading: `How did Vanderpoole even create that signature?`,
      paragraph_one: `Holocat chimes in and says a defector in BitRey has sent us a list of public keys Vanderpoole commonly uses, maybe he used one of these keys to sign the message.`,
      paragraph_two: `Please provide the key that successfully completes the verification process, allowing us to identify the public key Vanderpoole used to sign this message.`,
      paragraph_three: `Let's see if you can verify Vanderpoole's message and signature using one of THESE keys?`,
      success: `The signature is valid for this public key of Vanderpoole's, this was not Satoshi!`,
    },
    outro_one: {
      title: `Outro`,
      nav_title: `Chapter complete`,
      heading: `Vanderpoole lied!`,
      paragraph_one: `You learned one of the most important lessons in bitcoin. You didn't trust, you verified.<br><br>In doing so, you discovered that Vanderpoole didn't use Satoshi's keys to sign the message, casting a big shadow on his family story, on his credibility, and the credibility of BitRey.<br><br>Now if only you could get that song out of your head.`,
    },
    resources: {
      derive_message_three: {
        op_pushdata_heading: `OP_PUSHDATA`,
        op_pushdata_paragraph_one: `OP_PUSHDATA in bitcoin script plays a crucial role in facilitating the insertion of arbitrary pieces of data into the blockchain. It is actually a whole category of opcodes that allow for the inclusion of data elements of varying sizes, making Bitcoin's scripting language more versatile. This opcode is particularly significant in enabling the implementation of various smart contract functionalities and custom transaction types. Given that we know this is supposed to push 71 bytes of data onto the stack, can you work out how this opcode might be represented in hex? You can read more about some of these OP_CODES and more <Link href="https://en.bitcoin.it/wiki/Script#Constants" target="_blank" className="underline">here</Link>.`,
      },
      derive_message_four: {
        op_checksig_heading: `OP_CHECKSIG`,
        op_checksig_paragraph_one: `OP_CHECKSIG in bitcoin script is critically important to ensuring that the correct private key is able to spend a given transaction. In almost every bitcoin script there will be an OP_CHECKSIG to ensure that the person attempting to spend the bitcoin is able to do so with the given key. You can read about some of these OP_CODES and more <Link href="https://en.bitcoin.it/wiki/Script#Constants" target="_blank" className="underline">here</Link>.`,
      },
      derive_message_six: {
        transaction_parts_heading: `Transaction Parts`,
        transaction_parts_one: `Version: This version indicates how the the transaction will be organized.`,
        transaction_parts_two: `Number of inputs: The number of inputs in this transaction.`,
        transaction_parts_three: `Input #0 TXID: This is the hash of the transaction that input #0 spends from.`,
        transaction_parts_four: `Input #0 index: This is the output index of the transaction identified by the above TXID that provides a source of funds.`,
        transaction_parts_five: `Scriptsig: This is the data that authorizes the spending of the output specified above. Typically consists of signatures.`,
        transaction_parts_six: `Input #0 sequence: This is the sequence number for the spending input.`,
        transaction_parts_seven: `Number of outputs: This indicates how many outputs the tx has.`,
        transaction_parts_eight: `Output #0 value: This is the amount that is spent by the first output, expressed as a little-endian integer.`,
        transaction_parts_nine: `Output #0 scriptPubKey: This is the script that determines what is required to spend the funds. Typically consists of a public key and other opcodes that form a challenge.`,
        transaction_parts_ten: `Output #1 value: This is the amount that is spent by the second output, expressed as a little-endian integer.`,
        transaction_parts_eleven: `Output #1 scriptPubKey: This is the script that determines what is required to spend the funds. Typically consists of a public key and other opcodes that form a challenge.`,
        transaction_parts_twelve: `Locktime: A block height before which this transaction is not valid for confirmation.`,
      },
      derive_message_seven: {
  ...
  chapter_six: {
    title: `The Keyholder`,
    paragraph_one: `Ahhh! Vanderpoole is out to get you for exposing his fraudulent claims. But despite the fact that the holocat is out of the bag, plenty of scared people continue to cling to the myth that Vanderpoole created around himself, his family, and their supposed ancestry. Times are scary, and people need a hero. Unfortunately, for many, he's the best they've got.`,
    intro_one: {
      title: `Intro`,
      nav_title: `Was that really Satoshi`,
      paragraph_one: `—SATOSHI NAKAMOTO: ”Well done. Now the world can see for itself that Vanderpoole is a fraud. Even if some don't believe it yet, they will before our work is done.”`,
      paragraph_two: `You pause for a moment and realize that every message up to this point has been signed “Satoshi Nakamoto.” You had just assumed that this was a pseudonym used by someone who adheres to bitcoin's core principles. Surely, they couldn't be the real Satoshi Nakamoto. But, you finally decide, it's worth asking.`,
      paragraph_three: `—”This might make me sound stupid, but are you the real Satoshi?”`,
    },
    intro_two: {
      title: `Intro`,
      nav_title: `Paying Mika 3000`,
      paragraph_one: `—HOLOCAT: “Hardly the only thing to make you sound stupid lately.”`,
      paragraph_two: `—SATOSHI NAKAMOTO: “Bitcoin moved far beyond its creator's control many years ago. It would not matter if Vanderpoole or I were Satoshi, or one of their descendants. Bitcoin is defined by its community and cannot be co-opted by a single individual or entity—including Satoshi. Proving this is the real battle. I hope you don't mind, but I asked your eccentric freelance reporter friend to reach out.”`,
    ...
    in_out_one: {
      ...
      paragraph_one: `Mika 3000 needs 1 BTC to buy gear for her trip to Vanderpoole's private island. You decide to send her 1 BTC from your chapter 3 mining rewards, which have been sent by the mining pool to the address you created in chapter 4.`,
      paragraph_two: `You open your bitcoin full node and execute a command to see where your money is in the blockchain.`,
      paragraph_three: `This is an unspent transaction output (aka "UTXO"). You might recognize your compressed public key hash and address from chapter 4. The amount looks right, too: 1.61 BTC.`,
    },
    in_out_two: {
      title: `The ins and outs`,
      nav_title: `The receiving address`,
      paragraph_one: `Mika 3000 gives you an address to send your 1 BTC contribution to:`,
      paragraph_two: `Hm, that address looks a lot longer than yours! I wonder why...`,
    ...
    in_out_four: {
      normal: {
        ...
        paragraph_one: `Here we have code for two classes: an <span className="font-bold">Input</span> class and an <span className="font-bold">Outpoint</span> (not "output"!) class.`,
        paragraph_two: `Inputs come from unspent transaction outputs. If you provide the description of an output to the <span className="text-green p-1 font-mono bg-[#00000033] m-1 text-base">from_output()</span> method, it will create an instance of the Input class:`,
        paragraph_three: `The first two arguments are:`,
        paragraph_four: `1. <span className="font-bold">txid: </span>the ID of the transaction that created the output, and`,
        ...
        paragraph_seven: `The second two arguments are the value of the output we want to spend (in satoshis) and something called a scriptcode. That data is not needed until later so let's temporarily use an empty byte array.`,
        paragraph_eight: {
    ...
    in_out_five: {
      ...
      paragraph_one: `Like the Input class, it needs a method <span className="text-green p-1 font-mono bg-[#0000004D] m-0.5 text-sm">from_options()</span> that will construct an Output object from user-provided data:`,
      ...
      paragraph_three: `Don't forget: integers in bitcoin are serialized little-endian!`,
    ...
    put_it_together_one: {
      ...
      normal: {
        ...
        paragraph_six: `The raw transaction has a preimage that is the serialization of:`,
        headings: {
        ...
        paragraph_seven: `Finally, the message we sign is the double SHA-256 of all this serialized data.`,
      ...
      hard: {
        ...
        paragraph_one: `It should have the following method, which accepts a byte array and adds that item to the witness stack.`,
        paragraph_two: `It will also need a <span className="text-green p-1 font-mono bg-[#0000004D] m-0.5 text-sm">serialize()</span> method that returns the serialized witness stack.`,
    ...
    put_it_together_two: {
      normal: {
        ...
        paragraph_one: `In the last chapter, we wrote some important ECDSA signature verification code. Now, in order to create a valid signature, we are going to take that code and rearrange it a bit.`,
        paragraph_two: `In this exercise we'll be implementing some of the math behind the ECDSA signing algorithm. For more information on how that works, check out these resources:`,
        ...
        heading_five: `Step 5`,
        paragraph_ten: `The last step is to create a Witness object with two stack items: the DER encoded signature blob we just made, and your compressed public key. Push the signature first, followed by the public key.`,
        paragraph_eleven: `Append the witness stack object to the transaction object's array of witnesses.`,
        success: `The compute_input_signature() and sign_input() methods look good. Great Work!`,
      },
      hard: {
        title: `Putting it all together`,
        ...
        paragraph_two: `It will need a <span className="text-green p-1 font-mono bg-[#0000004D] m-0.5 text-sm">serialize()</span> method that outputs the enitire transaction as bytes formatted for broadcast on the bitcoin p2p network.`,
        headings: {
          item_one: `Description`,
          item_two: `Name`,
          item_three: `Type`,
    ...
    put_it_together_three: {
      normal: {
        ...
        heading: `Finish the implementation of Class Transaction`,
        paragraph_one: `To complete our transaction we will need a <span className="text-green p-1 font-mono bg-[#0000004D] m-0.5 text-sm">serialize()</span> method that outputs the entire transaction as bytes formatted for broadcast on the bitcoin p2p network.`,
        paragraph_two: `Our script should create and sign a Transaction object. It will have one input (the UTXO we identified in <span className="underline">The input class</span>) and two outputs:`,
        paragraph_three: `We know our input, we know our output. Are we ready to build and sign a transaction? Not quite. We have a 1.61 BTC input and a 1 BTC output... what happens to the other 0.61 BTC? Most of that will be "change" and we need to send it back to our own address!`,
        paragraph_four: `Notice that there is no "count" value for witnesses. That is because the number of witness stacks must always be exactly equal to the number of inputs.`,
        ...
        paragraph_six: `Finally our work is done. Your script should end by returning the result of the transaction serialize() method. This is a valid signed bitcoin transaction and we can broadcast it to the network to send Mika 3000 the money she needs!`,
        headings: {
          item_one: `Description`,
          item_two: `Name`,
          item_three: `Type`,
    ...
    outro_one: {
      ...
      nav_title: `Chapter complete`,
      heading: `You did it!`,
      paragraph_one: `You successfully built a transaction from scratch to pay Mika 3000 for her help. Now that we are done here let's see what we can find on Vanderpoole's island.`,
    },
    book_a_call_one: {
      title: 'Book a Call with BDP',
      nav_title: 'Book a call with BDP',
      heading: 'How about a call with the Bitcoin Dev Project?',
      paragraph_one:
      ...
      paragraph_two:
        '"Any chance you’d want to chat more about this whole bitcoin open-source software (BOSS) stuff? I know some people at the <Link className="!underline" target="_blank" href="https://bitcoindevs.xyz" /> Bitcoin Dev Project </Link>  I could introduce you to. They are always looking for bright coders like yourself to help build, strengthen, and secure bitcoin so it remains the future of more than just money."',
      paragraph_three:
        'This will take you to a calendar where you can book a real life video call with a member of the Bitcoin Dev Project to discuss ways to get more involved with bitcoin open-source software and related career opportunities. This is completely separate from the Saving Satoshi game and declining it will not affect your game progress.',
      button_text_one: 'Schedule a call',
      button_text_two: 'Continue the game',
    },
    resources: {
      in_out: {
  ...
  chapter_seven: {
    ...
    paragraph_one: `You and Mika 3000 reach Vanderpoole's private island first via plane and parachute, then via dune buggy, and then via rowboat that rows itself.`,
    intro_one: {
      title: `Intro`,
      nav_title: `Infiltrating the compound`,
      paragraph_one: `You ask your compatriots whether they are worried about Vanderpoole's army of security drones.`,
      paragraph_two: `—HOLOCAT: “Give me 15 minutes. They're basically birds, and I'm a cat. They don't stand a chance.”`,
      paragraph_three: `Holocat extends her claws and deals with Vanderpoole's drone army pounce by pounce. Mika 3000 hands you a black turtleneck sweater, gloves, and a pair of night vision goggles.`,
      paragraph_four: `—MIKA 3000: “You can't do espionage in a Hawaiian shirt. What were you thinking? This isn't another abandoned warehouse; this is a fortress. Here, I almost forgot. Take this grappling hook.”`,
      paragraph_five: `Wondering what you've gotten yourself into, you and Mika 3000 scale the castle walls of Vanderpoole's primary residence. To your surprise, his home overflows with pro-bitcoin art, books, and paper magazines. He is, or rather was, a true bitcoiner. A collection of miners dating back 125 years sit preserved in glass display cases. That's when you see it: Vanderpoole's workshop.`,
    },
    intro_two: {
      nav_title: `The control room`,
      paragraph_one: `The gigantic room is a mess, though its layout is methodical. Remember when miners were clogging up the bitcoin network with empty blocks? Inside open notebooks, you find Vanderpoole's designs for the backdoor that he used sketched out in detail. You were right: It was all a lie, yet one told not by a conniving villain but by a desperate believer in bitcoin whose company could no longer compete. To preserve his legacy, Vanderpoole infected the miners with a virus.`,
      paragraph_two: `The virus replaces a section of the code used by all miners, regardless if they are part of a pool or not. It is the block building logic, the algorithm that assembles transactions into a block template. The template is still passed on to legitimate hashing code for proof-of-work. Templates are combined with zillions of different nonces while searching for a valid hash, but by the time one is found, the damage–the absence of any transactions in the block template, has been done.`,
      paragraph_three: `—HOLOCAT: “What a loss. His family was once great. It's so sad to see the Vanderpoole's come to this.”`,
    },
    intro_three: {
      nav_title: `Correcting the software`,
      paragraph_one: `But you can't just leave the crippled mining code on Vanderpoole's server. It will keep infecting miners. You have to fix it! As you read through the code, Holocat shows you a mempool display that is filling with unconfirmed transactions. The sooner this code gets fixed, the better.`,
    },
    mempool_transaction_one: {
      ...
      paragraph_three: `You can make the following assumptions to complete your mission:`,
      bullet_one: `All transactions in the mempool have already been verified as valid.`,
      bullet_two: `The coinbase transaction, and the weight it contributes to the block, can be ignored.`,
      paragraph_four: `You can view the entire raw mempool JSON file <Link href="https://github.com/saving-satoshi/resources/blob/main/chapter-7/mempool.json" target="_blank" className="underline">here</Link>.`,
      paragraph_five: `Or browse an excerpt of the file in this table for some basic patterns:`,
      headings: {
      ...
      table_one: {
        footer: `View the json file  <Link href="https://github.com/saving-satoshi/resources/blob/main/chapter-7/mempool.json" target="_blank" className="underline">here</Link> for the rest of the transaction data`,
      },
    ...
    outro_one: {
      ...
      nav_title: `Chapter complete`,
      heading: `You did it!`,
      paragraph_one: `You escape the compound and return home. Investors sell their BitRey shares en masse when the story drops, plummeting Vanderpoole's net worth.`,
    },
    resources: {
      mempool_transaction_one: {
        bytes_v_weight_heading: `Bytes vs Weight Units`,
        bytes_v_weight_paragraph_one: `In bitcoin block construction, "weight units" (WU) and "bytes" are two different metrics used to measure the size of transactions and blocks.`,
        ...
        bytes_v_weight_paragraph_three: `Weighted units are a more complex metric introduced with SegWit in Bitcoin Improvement Proposal 141 <Link href="https://github.com/bitcoin/bips/blob/master/bip-0141.mediawiki#user-content-Other_consensus_critical_limits" target="_blank" className="undeline">BIP 141</Link>. This system aims to more fairly allocate block space by considering the impact of witness data separately.`,
        bytes_v_weight_paragraph_four: `In our lesson here its just important to note we are using weight units to calculate the maximum block size and the same for each tx so make sure your block does not exceed the maximum size of 4000000 weight units.`,
      },
    },
  },
  ...
  story_interlude: {
    ...
    vanderpoole_heading: `Vanderpoole claims Satoshi's legacy`,
    issuance_nav_title: `Perpetual issuance`,
    issuance_heading: `A plan beyond 21 million bitcoin`,
    verification_nav_title: `Don't trust, verify`,
    verification_heading: `The proof fails`,
    verification_result: `In the full course, the omitted signature exercises verify Vanderpoole's proof. His signature does not match Satoshi's public key.`,
    investigation_nav_title: `The private island`,
    investigation_heading: `Mika follows the evidence`,
    investigation_funding: `Mika 3000 needs 1 BTC to buy gear for the trip. You fund it with 1 BTC from your 1.61 BTC mining reward.`,
    infiltration_nav_title: `Infiltrating the compound`,
    infiltration_heading: `Inside Vanderpoole's compound`,
    malware_nav_title: `The empty-block malware`,
    malware_heading: `The malware is uncovered`,
    repair_nav_title: `Repair and disclosure`,
    repair_heading: `The software is repaired`,
    repair_result: `In the full course, you repair the block-construction code. In this workshop summary, the repaired software once again builds blocks from the transactions waiting in the mempool.`,
    closing_bridge: `The evidence becomes public, and the story moves forward.`,
  },
  ...
  chapter_eight: {
    ...
    building_blocks_one: {
      ...
      paragraph_three: `Now, on live TV in front of the entire world, you need to find the longest valid blockchain and verify the coin supply's integrity. While you're at it, you'll also be able to prove that Vanderpoole has turned the bitcoin network into an invalid block minefield.`,
    },
    building_blocks_two: {
      title: `Building blocks`,
      nav_title: `A bitcoin block tree`,
      paragraph_one: `Every block has exactly one preceding block, but could have more than one next block. Because of this, bitcoin blocks form more of a tree than a chain. Some of the branches are dead-ends and, as you must prove, some of the branches are invalid because of Vanderpoole's shenanigans.`,
      paragraph_two: `Somewhere in this maze is a path from the genesis block to today's most recent block. You have to find it and tell Deborah Chunk which block is on the tip of the tree's most valid chain... before the next commercial break. Ahhh!`,
      paragraph_three: `This artistic interpretation of bitcoin's blockchain “tree” shows how every block has exactly one parent, but could have more than one child. Each block is labeled with its hash, and the hash of its parent (<span className="p-1 font-mono m-0.5 text-sm">prev</span>).`,
      paragraph_four: `Some of these blocks are red because they are invalid. The longest path of blocks starting from the genesis block is colored green and represents the “most work” or “most valid” chain. Transactions in these blocks are the only truly “confirmed” transactions. Other valid blocks, the blue ones, don't have as many descendants as the “most work” chain. They terminate in what are called <span className="italic">stale tips</span>.`,
    },
    building_blocks_three: {
      ...
      paragraph_three: `The API also has a convenient "help" method! Ask it for help to learn more about the available commands, then pass the challenge by printing the current network difficulty.`,
    ...
    building_blocks_five: {
      ...
      paragraph_two: `The "inputs" array is the coins spent (destroyed) by the transaction and the "outputs" array is the coins created by the transaction. A transaction fee incentivizes miners to include the transaction in a block. It is calculated as the total input value minus the total output value.`,
  ...
  chapter_nine: {
    ...
    intro_one: {
      title: `Intro`,
      nav_title: `Threats`,
      paragraph_one: `Everyone is celebrating; everyone is smiling. But there is one man on set who isn't happy: a tall, well-dressed, gray-haired man who you recognize immediately. The crowd parts, and you see him face to face for the first time: Vanderpoole!`,
      paragraph_two: `His fists are clenched. You have ruined his business and exposed his family's long con. The first thing out of his mouth is a threat to sue you every day for the rest of your life "times infinity".`,
    },
    intro_two: {
      title: `Intro`,
      nav_title: `Coming to terms`,
      paragraph_one: `As Vanderpoole rants, a producer walks in and tells you that viewers from around the world want to support your cause by donating bitcoin and calzones to you for... some reason! Deborah asks you to provide their viewership with a wallet address.`,
      paragraph_two: `This makes Vanderpoole even more furious. He demands that you split the incoming donations with him, or he'll drown you in even more lawsuits, as if there can be more than infinity lawsuits.`,
      paragraph_three: `Sharing donations with Vanderpoole doesn't make much sense. The money is coming from people that want to thank you for exposing Vanderpoole's efforts to undermine bitcoin. It dawns on you that this demand is more about him losing than wanting money. For a moment, you even start to feel bad for him. He's backed himself into a corner with no way out.`,
      paragraph_four: `As if she could read your mind, Deborah Chunk steps in. She asks if there is a charity Vanderpoole would like to see a portion of the donations go to. To your surprise, he enthusiastically names the Lil Bits Foundation, a non-profit dedicated to helping children.`,
      paragraph_five: `Vanderpoole's complexion calms from radish red to beet purple. You start creating a bitcoin script contract between you and Vanderpoole. He is responsible for getting the funds to the Lil Bits Foundation. This script contract is what you will use to derive the donation address. It will treat Vanderpoole as an untrustable counterparty and ensure you both can spend from it how and when you agree.`,
    },
    opcodes_one: {
      title: `OpCodes`,
      nav_title: `Bitcoin script`,
      heading: `Bitcoin script`,
      paragraph_one: `We mentioned bitcoin script back in chapter 6 but we didn't dwell on it because the coins you were spending were locked by a simple mechanism: a single signature and an implied script that evaluated that signature with a public key. Now things are going to get more interesting.`,
      paragraph_two: `There are two important parts to spending a bitcoin output: A script and a stack.`,
    ...
    opcodes_two: {
      ...
      heading: `The stack`,
      paragraph_one: `Think of a stack of books 📚. If you want to add a book, you have to place it on top of the stack. There's nowhere else for it to go. If you want to read a book, the only one you can access is the one on top of the stack. Even if you want more than one you have start at the top of the stack and work your way down. In computing terms, a stack is like an array of data items with two operations:`,
      paragraph_two: `<span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_PUSH</span> Add an item to the "top" of the stack.`,
      paragraph_three: `<span className="text-[#3DCFEF] w-fit rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_POP</span> Remove the "top" item from the stack for processing.`,
      subheading_one: `Example:`,
      stack_list_one: `Here is a stack: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">[]</span>`,
      stack_list_two: `Push the number 1: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">[1]</span>`,
      stack_list_three: `Push the number 2: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">[1, 2]</span>`,
      stack_list_four: `Pop the top item off the stack: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">[1]</span>`,
      paragraph_four: `Notice that the first item pushed on to the stack will be the last item popped off the stack, so it will be the last item processed by the script. For this reason the stack has an "upside down" or "backwards" feel to it, and the first thing you see on the stack will likely be the solution required at the end of script processing.`,
      paragraph_five: `When spending a bitcoin transaction output, the elements required by the spender are provided in the witness section of the spending transaction's input (see chapter 6) and those elements get pushed on to the stack before any script processing begins. We will refer to those items as the INITIAL STACK. They are important because they are literally the data that unlocks a script and allows coins to be spent!`,
    },
    opcodes_three: {
      title: `OpCodes`,
      nav_title: `OpCodes`,
      heading: `OpCodes`,
      paragraph_one: `Script is a linear series of commands that are executed one by one, manipulating items on the stack. When the end of the script is reached, there must be EXACTLY ONE NON-ZERO (NON-FALSE) ITEM remaining on the stack, or the entire operation is invalid and so is your bitcoin transaction. There are over 100 commands in the bitcoin script language, called "opcodes". We are only going to use a handful of them for this challenge.  `,
      paragraph_two: `Let's demonstrate an example where we lock up a bitcoin with the math problem 1 + 2 = ? Whoever knows the answer to this math problem can spend the coins.`,
      ...
      paragraph_five: `This is script will be hashed and bech32-encoded into an address where someone can send coins.`,
    },
    opcodes_four: {
      title: `OpCodes`,
      nav_title: `The stack solution`,
      heading: `The stack solution`,
      paragraph_one: `The stack solution would look like this and the spending transaction needs to contain all these elements. They go in the witness section of the input that is trying to spend these coins. Let's step through it:`,
      table_one: {
        headings: {
          item_one: `Step`,
      ...
      stack_list_one: `init: the funding transaction output and spending transaction input are brought together.`,
      stack_list_two: `step 1: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_1</span>pushes "1" onto the stack.`,
      stack_list_three: `step 2: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_2</span>pushes "2" onto the stack.`,
      stack_list_four: `step 3: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_ADD</span>pops two items off the stack, adds them together, and pushes the sum back to the stack.`,
      stack_list_five: `step 4: <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_EQUAL</span>pops two items off the stack, compares them, and pushes a boolean result back to the stack.`,
      paragraph_two: `Now we have reached the end of the script and there is only a single TRUE item left on the stack - the coins are spent!`,
      paragraph_three: `If we started this example with a 4 on the stack, we would not be able to spend the coins because the OP_EQUAL would evaluate to FALSE. For these challenges we are going to use a very limited set of opcodes, which we will introduce by category.`,
    },
    opcodes_five: {
      title: `OpCodes`,
      nav_title: `Compute basic arithmetic`,
      heading: `Basic Arithmetic`,
      paragraph_one: `Bitcoin script can do simple math operations. You could lock coins using simple math but then anyone who can do math could spend the coins! In other words, do not try this on mainnet.`,
      subheading_one: `Opcodes that push integers or arbitrary data to the stack`,
      ...
      opconstants_list_five_paragraph: `Pushes a duplicate of the top stack item on to the stack.`,
      ...
      oparithmetic_list_one_paragraph: `Pops two items off the stack, adds them together, pushes their sum back to the stack.`,
      ...
      oparithmetic_list_two_paragraph: `Pops two items off the stack, compares their equality, pushes a boolean back to the stack.`,
      ...
      oparithmetic_list_three_paragraph: `Like OP_EQUAL but throws an error and halts script execution immediately if the two items are not equal.`,
    ...
    opcodes_six: {
      ...
      opcryptography_list_one_paragraph: `Pops one item off the stack, computes the double-SHA256 digest and pushes that digest back to the stack. In our exercise this operation is symbolized using strings. Example: The script OP_1 OP_HASH256 produces the stack [HASH256(1)]`,
    ...
    opcodes_eight: {
      ...
      subheading_one: `Processes m-of-n multisignature by following this algorithm.`,
      multisig_list_one: `Pop a single integer off the stack. This is the <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">n</span> value.`,
      multisig_list_two: `Pop <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">n</span> number of items off the stack, these are all expected to be public keys of the format <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">PUBKEY(...)</span>`,
      multisig_list_three: `Pop a single integer off the stack. This is the <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">m</span> value.`,
      multisig_list_four: `Pop <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">m</span> number of items off the stack, these are all expected to be signatures of the format <span className="text-[#3DCFEF] rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">SIG(...)</span>`,
      multisig_list_five: `Pop an extra element off the stack for absolutely no reason at all.`,
      ...
      multisig_list_seven: `If all public keys have been tested and there are any signatures remaining, the operation fails.`,
      multisig_list_eight: `Once all signatures have been removed the operation can finish early with success, even if more public keys remain.`,
      paragraph_one: `Note that m <= n. There may be more public keys than signatures but never more signatures than public keys. Also note that the keys and signatures MUST be in the same order, even if some keys are not used to sign.`,
      paragraph_two: `Provide the initial stack to spend from the script.`,
    },
    opcodes_nine: {
      title: `OpCodes`,
      ...
      optimelock_list_two_paragraph: `Reads (does not pop) the top stack item and interprets it as a block height. If the height argument consumed by the opcode is not at least equal to the NEXT block height, the operation is invalid.`,
      paragraph_two: `Provide the initial stack to spend from the script.`,
    },
    opcodes_ten: {
      title: `OpCodes`,
    ...
    proposal_four: {
      ...
      paragraph_one: `Vanderpoole changes his mind again. He doesn't like that deal because of the unknowns. He decides he wants the Lil Bits foundation to get the first 1.0 BTC of total donations, and you can spend the rest afterward.`,
      paragraph_two: `There is no way to check a total balance across multiple UTXOs in bitcoin script so you agree on an unbiased third-party oracle: Deborah Chunk! She will monitor the total donation amount on the blockchain and once they add up to at least 1.0 BTC she will announce, live on TV, the preimage to a hash value you will commit to in the script.`,
      paragraph_three: {
    ...
    outro_one: {
      ...
      nav_title: `Chapter Complete`,
      heading: `Way to go!`,
      paragraph_one: `The donations have now been distributed to you and the Lil Bits Foundation and many viewers thank you for shining a light on Vanderpoole's actions. While the decentralized nature of bitcoin makes it difficult to overtake the network, it doesn't stop people like him from trying. You're relieved the truth is finally out, especially after all the effort it took to get here.`,
    },

    resources: {
      opcodes_five: {
        arithmetic_heading: `Arithmetic opcodes`,
        arithmetic_paragraph: `In bitcoin script arithmetic operations like in math take in some inputs to conduct math operations on. In actual bitcoin script the inputs are limited to signed 32-bit integers but the output may overflow.`,
        spoiler: `Put in two integers that give the sum of 3 in the initial stack`,
      },
      opcodes_six: {
        cryptography_heading: `Cryptographic opcodes`,
        cryptography_paragraph: `These opcodes are important in everyday transactions as they ensure the outputs can only be spent with the signature of the owner of that utxo. Note that there are no formal categories of opcodes and that they are only organzied by their hex code representation.`,
      ...
      opcodes_eight: {
        ...
        multisig_paragraph: `<span className="text-[#3DCFEF] rounded-sm px-1.5 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_CHECKMULTISIG</span> has a notable bug that requires the stack to include another unused value on the top of the stack unrelated to the actual multisig.`,
      ...
      opcodes_nine: {
        ...
        timelock_paragraph: `Bitcoin script can read the current block height allowing transactions to be locked based on bitcoin blocks in the future. the exact semantics of the actual <span className="text-[#3DCFEF] rounded-sm px-1.5 h-[28px] font-mono bg-[#0000004D] m-0.5 text-sm">OP_CHECKLOCKTIMEVERIFY</span> can be found`,
        timelock_link: `<Link target="_blank" href="https://github.com/bitcoin/bips/blob/master/bip-0065.mediawiki" className="underline">here</Link>.`,
      ...
      opcodes_ten: {
        ...
        conditionals_paragraph: `Conditional opcodes allow for some basic programming logic branches.  While the conditional logic allows for a broad range of additional possibilities in bitcoin script, it is still limited in comparison to a traditional programming language.`,
      ...
      proposal_two: {
        ...
        making_script_paragraph: `Remember that scripts can only be validated if the finish with a single truthy value on the stack. some versions allow any truthy value but our script editor only allows for values equal to 1 or true.`,
...
Stack Hint: To spend before the secret is revealed, Vanderpoole uses his signature. After the secret is revealed, you use your signature, a hash of the secret, and provide a 0 because the script has moved past the unrevealed verification.`,
  ...
  chapter_ten: {
    ...
    intro_two: {
      ...
      paragraph_one: `—MIKA 3000: “That is so cool. As long as it isn't 10,000 bitcoin, we'll take one of those pizzas and a couple of Lightning Lemonades. Shame about the calzones, though.”`,
      paragraph_two: `Mika 3000 and Laszlo pull out their solar-powered ePhone Infinities and start tapping buttons.`,
      paragraph_three: `—MIKA 3000: “Uh oh. Your little stunt back there did a number on miner fees. The bitcoin network is experiencing a surge in activity and transaction fees are through the roof! We're going to have to pay for this off-chain.”`,
    },
    intro_three: {
      title: `Off-chain?`,
      nav_title: `Off-chain?`,
    ...
    opening_a_channel_one: {
      ...
      paragraph_one: `You have a confirmed UTXO in the blockchain for 101,000 satoshis. It seems pretty simple to make an off-chain payment, right?`,
    },
    opening_a_channel_two: {
      ...
      paragraph_one: `Let's create a valid bitcoin transaction but instead of broadcasting it out to the network, we'll give it directly to Laszlo. In return, he should provide you with a Lightning Lemonade because he can broadcast the transaction anytime he wants. Once it's confirmed and mined into a block, the money is his.`,
      paragraph_two: `Remember it's the year 2140! A Lightning Lemonade costs 0.00001000 BTC.`,
      heading_two: `Instructions`,
      off_chain_list_one: `Fill in the two output amounts: 1000 satoshis to Laszlo in the first output, and the rest to yourself as change in the second output.`,
      off_chain_list_two: `To get the money, Laszlo will need to broadcast this transaction to the network, and that requires a miner fee. Let's set aside 1000 sats to pay that fee. Update the amount in your change output to account for this.`,
      off_chain_list_three: `Write the two output scripts`,
      off_chain_list_four: `Sign the input by clicking <span className="rounded-sm px-1.5 py-1 h-[28px] bg-[#0000004D] m-0.5 text-base">Sign</span>`,
    ...
    opening_a_channel_four: {
      ...
      multisig_two: `Sign the input by clicking <span className="rounded-sm px-1.5 py-1 h-[28px] bg-[#0000004D] m-0.5 text-base">Sign and Broadcast</span>`,
      heading_three: `Hints`,
    ...
    updating_the_state_two: {
      ...
      paragraph_three: `Before I sign this, I need a guarantee that this refund transaction can be revoked.`,
    ...
    updating_the_state_four: {
      ...
      paragraph_one: `—LASZLO: "Well, this is better, but it just occurred to me that even if I have the revocation key, it will still be a race between you and me to spend this output.`,
      paragraph_two: `I need a decent head start so I have a chance to notice if you cheated me. Then I can sweep the bitcoin with the revocation key before you take a full refund."`,
    },
    updating_the_state_five: {
      title: `The time lock`,
      nav_title: `The time lock`,
      heading_one: `The time lock`,
      time_lock_list_one: `Add a 700 block delay before you can spend the output`,
      time_lock_list_two: `Send it to Laszlo by clicking <span className="rounded-sm px-1.5 py-1 h-[28px] bg-[#0000004D] m-0.5 text-base">Send to Laszlo</span> so he can sign it`,
      time_lock_list_three: `Don't sign it yourself yet!`,
      heading_two: `Hints`,
      paragraph_one: `Output 0 is spent by EITHER:`,
      hint_one: `The initial stack if you claim the funds after 700 blocks: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base whitespace-nowrap">SIG(YOU) 1</span> `,
      hint_two: `The initial stack if Laszlo claims the funds: <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base whitespace-nowrap">0 SIG(REVOCATION_YOU_1) SIG(LASZLO) 0 </span> `,
    },
    updating_the_state_six: {
      title: `Channel open with Laszlo`,
      nav_title: `Channel open with Laszlo`,
      paragraph_one: `This time, when you give the transaction to Laszlo, he smiles and applauds! He signs the refund (child) transaction and now you can sign and broadcast the parent transaction that deposits the funds to the 2-of-2 multisig. The payment channel is now open!`,
    },
    making_a_payment_one: {
      ...
      list_one: `You sent 100,000 satoshis to a 2-of-2 multisig output between you and Laszlo.`,
      list_two: `You have, offline, a refund transaction that spends that output.`,
      list_three: `That refund transaction specifies two options for how the funds can be spent:`,
      list_three_sub_one: `You to get all 99,000 satoshis back accounting for fees after 700 blocks, or`,
      list_three_sub_two: `Laszlo gets all the money if he gets the private key <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base">REVOCATION_YOU_1</span> from you`,
      list_four: `Laszlo has already signed this refund transaction, and you can sign it whenever you want to broadcast it.`,
      list_five: `Once Laszlo signed this refund (child) transaction, you were safe to sign and broadcast the parent transaction that sends the funds to the 2-of-2 multisig.`,
      paragraph_two: `The transaction that funded the multisig output is called the <span className="font-bold">funding transaction</span>. Confirming it on the blockchain <span className="font-bold">opens</span> the payment channel.`,
      ...
      paragraph_four: `While the channel is open, you and Laszlo can make offline payments to each other, back and forth, by negotiating new commitment transactions and revoking old ones. As you buy more drinks, your "refund" amount will go down and Laszlo's portion of the original 100,000 satoshis locked in the multisig goes up.`,
    },
    ...
    making_a_payment_six: {
      ...
      paragraph_two: `There are several off-chain transactions that spend the 100,000 satoshi (sat) output locked in the 2-of-2 multisig:`,
      paragraph_three: `You will end up with these transactions:`,
      paragraph_four: `Commitment 1 (You)`,
      commitment_one_you: {
        list_one: `<span className="font-semibold">Input 0:</span> signed by Laszlo`,
        list_two: `<span className="font-semibold">Output 0:</span> 99,000 sats to you after 700 blocks or Laszlo with <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base">REVOCATION_YOU_1</span>`,
        list_three: `<span className="font-semibold">Miner fees:</span> 1,000 sats`,
      },
      commitment_two_you: {
        list_one: `<span className="font-semibold">Input 0:</span> signed by Laszlo`,
        list_two: `<span className="font-semibold">Output 0:</span> 98,000 sats to you after 700 blocks or Laszlo with <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base">REVOCATION_YOU_2</span>`,
        list_three: `<span className="font-semibold">Output 1:</span> 1,000 sats to Laszlo`,
      ...
      commitment_two_laszlo: {
        list_one: `<span className="font-semibold">Input 0:</span> signed by you`,
        list_two: `<span className="font-semibold">Output 0:</span> 1,000 sats to Laszlo after 700 blocks or you with <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base">REVOCATION_LASZLO_1</span>`,
        list_three: `<span className="font-semibold">Output 1:</span> 98,000 sats to you`,
        list_four: `<span className="font-semibold">Miner fees:</span> 1,000 sats`,
      },
    ...
    outro_one: {
      ...
      paragraph_one: `You can do this all night long! Well, until your 100,000 satoshis have all been sent to Laszlo anyway`,
      paragraph_two: `Don't forget to drink some water! They have holodogs and nachos too.`,
    },
    ...
    tab_data: {
      signed: `signed`,
      pending: `pending`,
      deposit: `This is an output of 101,000 sats in your wallet that you are going to use for your off-chain payments with Laszlo.`,
      payment: `This is your off-chain payment to Laszlo.`,
      multisig: `This transaction will fund a multisig output between you and Laszlo.`,
      refund_0: `This transaction ensures funds are not lost if Laszlo disappears.`,
      refund_1: `This transaction ensures funds are not lost if Laszlo disappears. It also ensures Laszlo that you will not broadcast it after paying for your Lightning Lemonade.`,
      refund_2: `This transaction ensures funds are not lost if Laszlo disappears. It also prevents you from claiming the funds immediately after paying for your Lightning Lemonade. If you try to take a full refund, including the 1,000 satoshis used to pay for the Lightning Lemonade, the 700 block delay gives Laszlo a few days to notice.`,
      commitment_you: `This is the second commitment transaction for this payment channel, that pays Laszlo 1,000 sats`,
      commitment_laszlo: `This is Laszlo's version of the commitment transaction.`,
    },
    resources: {
      output_zero_sig: `Output 0 Signature`,
      output_one_sig: `Output 1 Signature`,
      sats_distribution: `Laszlo should receive enough sats for the Lightning Lemonade, and is not responsible for the 1,000 sat miner fees. The fee comes out of your change.`,
      output_script: `The locking script on the output should not contain any signatures (i.e. <span className="rounded-sm px-1.5 py-1 font-mono bg-[#0000004D] m-1 text-base whitespace-nowrap">OP_PUSH SIG()</span>). If this is part of your script, simply remove it.`,
  ...
  chapter: {
    ...
    coming_soon: `Coming soon. Hang tight.`,
    description: `Explore the mysteries of Satoshi and learn about bitcoin along the way.`,
  },
  ...
  modal_signin: {
    heading: `Sign in`,
    pre_signin_paragraph_one: `Enter your private key below to restore your account and progress.`,
    post_signin_paragraph_one: `Nice to see you return to save Satoshi! You can go directly to your last lesson from here.`,
  ...
  modal_logout: {
    ...
    paragraph_one: `Your session will remain active until you sign out using the button below.`,
  ...
  help_page: {
    ...
    main_subheading: `What helpful info and resources can we provide for further learning?`,
    tips_heading: `Tips`,
    tips_subheading: `What specific tips can/do we want to give learners if they are stuck?`,

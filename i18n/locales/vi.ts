const translations = {
  ...
  chapter_one: {
    ...
    genesis_two: {
      ...
      paragraph_three: 'Sao chép giá trị mã hóa đó và dán vào khối mã hóa.', // Copy that value and paste it in the code block.
    ...
    resources: {
      ...
      transacting_two: {
        ...
        bitcoin_script_heading:
          'Các lệnh lập trình lệnh lập trình Bitcoin (Bitcoin script)', // lệnh lập trình Bitcoin (Bitcoin script)
  ...
  chapter_two: {
    ...
    hashing_one: {
      ...
      paragraph_two:
        'Màn hình hiển thị "CHUỖI MÃ HÓA KHÔNG ĐÚNG. HÃY THỬ LẠI."', // The monitor displays "INCORRECT HASH. TRY AGAIN."
      paragraph_three:
    ...
    hashing_two: {
      ...
      return_hash:
        'Dưới đây bạn sẽ thấy đầu vào của bạn được chuyển đổi thành một chuỗi mã hóa', // Below you will see your input converted to a hash
    ...
    hashing_three: {
      ...
      paragraph_two:
        'Bây giờ, hãy xem bạn có thể tìm thấy một số mã hóa cụ thể không nhé.', // Now, let’s see if you can find a specific hash.
      paragraph_three:
    ...
    mining_one: {
      ...
      heading_one:
        'Chúng ta đã biết cách khai thác(đào) khối, bây giờ hãy xem nó hoạt động như thế nào', // Now that we know how mining works, let’s see it in action
    ...
    outro_one: {
      ...
      paragraph_two: '—HOLOCAT: “Nhìn kìa, có tin nhắn.”', // —HOLOCAT: “Look, there’s a message.”
      paragraph_three:
  ...
  chapter_three: {
    ...
    paragraph_two: 'Đúng là mèo. Đâu có thể làm gì khác?', // Cats. What can you do?
    paragraph_three:
    ...
    paragraph_four: 'Không phải trùng hợp đâu.', // It’s not a coincidence.
    ...
    coop_two: {
      ...
      paragraph_two: 'Việc chia extra nonce thành hai phần có một số lợi thế:', // Splitting the extra nonce into two parts has several advantages:
      ...
      paragraph_four:
        'Chúng ta hãy thử lại với cách chia sẻ công việc bằng phương pháp này.', // Let’s try again splitting the work using this method.
    },
    ...
    resources: {
      ...
      pool: {
        pool_heading: 'Mỏ khai thác khối(pool)', // Mining Pool
        pool_paragraph:
      ...
      split: {
        ...
        pplns_heading:
          'Trả theo N cổ phần cuối cùng/Pay-Per-Last-N-Shares (PPLNS)', // Pay-Per-Last-N-Shares (PPLNS)
        pplns_paragraph:
  ...
  chapter_four: {
    ...
    public_key_three: {
      ...
      paragraph_four:
        'Dưới đây là một số gợi ý chuyển đổi kiểu để giúp bạn bắt đầu:', // Here are some type-conversion hints to get you started:
    ...
    address_three: {
      ...
      success:
        'Bây giờ bạn đã có một địa chỉ mà bitcoin được khai thác(đào) khối có thể được gửi đến.', // Now you have an address that mined bitcoin can be sent to.
    },
    ...
    resources: {
      ...
      address_three: {
        wpkh_heading:
          'Chứng nhận Địa chỉ khóa chung/Witness Public Key Hash (wpkh)', // Witness Public Key Hash (wpkh) address
        wpkh_paragraph:
  ...
  chapter_five: {
    ...
    paragraph_three: '2) Ông ta tuyên bố mình là chắt của Satoshi Nakamoto.', // 2) He is claiming to be the great-grandson of Satoshi Nakamoto.
    ...
    derive_message_one: {
      ...
      heading:
        'Vanderpoole nói rằng ông ta đã ký một thông điệp bằng các khóa của Satoshi:', // Vanderpoole says he signed a message with Satoshi’s keys:
    ...
    verify_signature_two: {
      ...
      tooltip_one: {
        question:
          'Tại sao mọi thứ trong bitcoin đều sử dụng mã hóa kép (HASH256)?', // Why does everything in bitcoin use double hash (HASH256)?
    ...
    validate_signature_two: {
      ...
      python: {
        paragraph_two: {
          ...
          return:
            'Nó nên trả về một bộ dữ liệu (tuple) với các giá trị (r, s).', // It should return a tuple with the (r, s) values.
        },
      },
      success: 'Làm tốt lắm', // Nicely Done
    },
    ...
    resources: {
      ...
      verify_signature_four: {
        eliptic_curve_heading:
          'Thuật toán đường cong elip (ECDSA) cho chữ ký kỹ thuật số', // Elliptic Curve Digital Signature Algorithm (ECDSA)
      ...
      validate_signature_one: {
        message_verification_heading:
          'Tầm quan trọng của việc xác minh thông điệp', // Importance of Message Verification
  ...
  chapter_six: {
    ...
    intro_two: {
      ...
      paragraph_three: '—Ông ta làm gì?', // —He what?
      paragraph_four: '—Ding.', // —Ding.
      paragraph_five: '—HOLOCAT: Đừng quên bấm vào tôi.', // —HOLOCAT: Don’t forget to boop me.
    ...
    in_out_four: {
      normal: {
        ...
        paragraph_three: 'Hai đối số đầu tiên là:', // The first two arguments are:
        paragraph_four:
        ...
        paragraph_eight: {
          ...
          b: {
            ...
            question:
              'Tại sao chúng ta đảo ngược giá trị mã hóa trong Bitcoin?', // Why do we reverse hashes in bitcoin?
          },
    ...
    put_it_together_one: {
      ...
      normal: {
        ...
        paragraph_four:
          '...mà giải mã thành lệnh lập trình Bitcoin (Bitcoin script) sau đây.', // ...which decodes to the following lệnh lập trình Bitcoin (Bitcoin script).
        paragraph_five:
        ...
        table: {
          ...
          row_ten: {
            item_one:
              'Loại mã hóa chữ ký, chúng ta sẽ sử dụng 1 để chỉ báo "ALL"',
            item_two: 'sighash',
            item_three: 'int',
            item_four: '4',
          },
    ...
    put_it_together_four: {
      hard: {
        ...
        success:
          'Phương thức compute_input_signature() thấy cũng ổn. Làm tốt lắm!',
      },
    },
  ...
  chapter_eight: {
    ...
    building_blocks_five: {
      ...
      paragraph_two: `Mảng "đầu vào" là các đồng xu được chi tiêu (bị phá hủy) bởi giao dịch và mảng "đầu ra" là các đồng xu được tạo ra bởi giao dịch. Phí giao dịch khuyến khích thợ đào đưa giao dịch vào một khối. Phí được tính bằng tổng giá trị đầu vào trừ đi tổng giá trị đầu ra.`, // The "inputs" array is the coins spent (destroyed) by the transaction and the "outputs" array is the coins created by the transaction. A transaction fee incentivizes miners to include the transaction in a block. It is calculated as the total input value minus the total output value.
  ...
  chapter_nine: {
    ...
    opcodes_five: {
      ...
      subheading_one: 'Các opcode đẩy số nguyên hoặc dữ liệu tùy ý vào stack', // Opcodes that push integers or arbitrary data to the stack
    ...
    proposal_four: {
      ...
      next_step_message:
        'Hãy xem liệu chúng ta có sử dụng chữ ký của mình với tiền ảnh chính xác không.', // Let's see if we used our signature with the preimage correctly.
    },
    outro_one: {
      title: 'Phần kết ', // Outro
      nav_title: 'Hoàn thành chương', // Chapter Complete
  ...
  chapter_ten: {
    ...
    tab_data: {
      ...
      commitment_laszlo: 'Đây là phiên bản giao dịch cam kết của Laszlo.', //   'This is Laszlo’s version of the commitment transaction.'
    },
    resources: {
  ...
  status_bar: {
    ...
    next_step_message:
      'Trông có vẻ ổn rồi, bây giờ chúng ta hãy chuyển sang bước tiếp theo.', // next_step_message: 'Looks good now lets move on to the next step.'
  ...
  hasher: {
    ...
    return_hash:
      'Dưới đây bạn sẽ thấy đầu vào của bạn được chuyển đổi thành một hàm mã hóa', // return_hash: 'Below you will see your input converted to a hash'
  },
  ...
  error: {
    ...
    second:
      'Holocat có thể đã gặm nhấm một số dây cáp một lần nữa. Con mèo xấu xa!', //con mèo may have chewed on some cables again. Bad cat!
    reload: 'Thử lại',
  },
  help_page: {

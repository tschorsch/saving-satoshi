const translations = {
  ...
  chapter_eight: {
    ...
    building_blocks_five: {
      ...
      paragraph_two: `Le tableau "inputs" contient les pièces dépensées (détruites) par la transaction, et le tableau "outputs" contient les pièces créées par la transaction. Les frais de transaction incitent les mineurs à inclure la transaction dans un bloc. Ils correspondent à la valeur totale des entrées moins la valeur totale des sorties.`,
